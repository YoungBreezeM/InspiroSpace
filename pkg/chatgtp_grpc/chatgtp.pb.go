...
var file_chatgtp_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x6b, 0x67, 0x22, 0x96, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71,
	...
	0x32, 0x18, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x61, 0x74, 0x12, 0x10, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x30, 0x01, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x63, 0x68,
	0x61, 0x74, 0x67, 0x74, 0x70, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_chatgtp_proto_goTypes = []interface{}{
	(*ChatRequest)(nil),        // 0: pkg.ChatRequest
	(*ChatReply)(nil),          // 1: pkg.ChatReply
	(*ChatRequestMessage)(nil), // 2: pkg.ChatRequest.message
}
var file_chatgtp_proto_depIdxs = []int32{
	2, // 0: pkg.ChatRequest.messages:type_name -> pkg.ChatRequest.message
	0, // 1: pkg.ChatGTPService.Chat:input_type -> pkg.ChatRequest
	1, // 2: pkg.ChatGTPService.Chat:output_type -> pkg.ChatReply
